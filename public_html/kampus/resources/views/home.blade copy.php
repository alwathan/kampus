...
<html>
	<head>
		...
		<title>Inkadha - Institut Kariman Wirayudha</title>	
											...
											<nav class="collapse">
												<ul class="nav nav-pills" id="mainNav">
														...
														<ul class="dropdown-menu">
															<li>
																<div class="dropdown-mega-content">
																	<div class="row">
																		<div class="col-lg-6">
																			<span class="dropdown-mega-sub-title">Strata 1 (S1)</span>
																		...
																		<div class="col-lg-6">
																			<span class="dropdown-mega-sub-title">Strata 2 (S2)</span>
																			<ul class="dropdown-mega-sub-nav">
													...
													<li class="dropdown">
														...
														<ul class="dropdown-menu">
															<li><a class="dropdown-item" href="shop-checkout.html">Sistem Akademik</a></li>
															<li><a class="dropdown-item" href="shop-login.html">Ejournal</a></li>
															<li><a class="dropdown-item" href="shop-cart.html">Pendaftaran</a></li>
														</ul>
													</li>
													<!--
													<li class="dropdown dropdown-mega">
